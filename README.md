...
2.Do customers prefer specific payment methods?
  Analyze payment method distribution to assess customer preferences and optimize checkout processes.

3.How do sales evolve over time?
  Detect seasonal trends, growth patterns, and anomalies to support forecasting and planning.
...
1.Data Ingestion & Initial Inspection
  Load the dataset and examine its structure, types, and quality issues.
...
3.Analyze category distribution
  ...
  Study sales over time (monthly/weekly trends)

4.Visualization
  Use bar charts, pie charts, and line graphs to present findings clearly.
